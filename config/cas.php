...
return [
    ...
    */
    'cas_hostname'        => env('CAS_HOSTNAME', 'shib.idm.umd.edu'),
    ...
    */
    ...
    | Sometimes is /cas
    */
    'cas_uri'             => env('CAS_URI', '/shibboleth-idp/profile/cas'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url'      => env('CAS_LOGOUT_URL', 'https://shib.idm.umd.edu/shibboleth-idp/profile/cas/logout'),
